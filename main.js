...
const dict = {
  ...
  hi: {
    ...
    subtitle: "आपके लिए सर्वोत्तम सरकारी योजनाएं ढूंढने के लिए हमें कुछ विवरण चाहिए।",
    ageLabel: "आयु (वर्ष)",
    ageInfo: "यह निर्धारित करता है कि आप पर कौन सी आयु-आधारित योजनाएं लागू होती हैं।",
    genderLabel: "लिंग",
    stateLabel: "राज्य",
    eduLabel: "शिक्षा का स्तर",
    incomeLabel: "वार्षिक पारिवारिक आय",
    incomeInfo: "आय-आधारित पात्रता सीमाएं जांचने के लिए उपयोग किया जाता है।",
    categoryLabel: "वर्ग / श्रेणी",
    categoryInfo: "कुछ योजनाएं श्रेणी के अनुसार अलग सुविधाएं देती हैं।",
    trustNotice: "आपका डेटा केवल योजनाओं की से मिलान के लिए उपयोग किया जाता है और हमारे सर्वर पर कभी सहेजा नहीं जाता।",
    submitBtn: "मेरी योजनाएं खोजें",
    eligibleHeader: "अनुशंसित सरकारी योजनाएं",
    eligibleSub: "आपके सत्यापित प्रोफाइल विवरण के आधार पर आप 3 प्रमुख योजनाओं के लिए पात्र हैं।",
    reasoningHeader: "BharatAI मैचिंग इंटेलिजेंस",
    reasoningSub: "पारदर्शिता इंजन: जानें आप इन योजनाओं के लिए क्यों पात्र हैं।",
    unqualifiedHeader: "योजनाएं जिनके लिए आप अयोग्य हैं",
    unqualifiedSub: "नीचे वे योजनाएं दी गई हैं जहां मानदंड पूरे नहीं हुए, साथ ही मार्गदर्शन भी।",
    viewDetails: "योजना विवरण देखें और आवेदन करें",
    applyNow: "आधिकारिक पोर्टल पर जाएं",
    backBtn: "← वापस योग्य योजनाओं पर जाएं"
  }
};
      ...
      <div class="w-full max-w-2xl bg-surface-container-lowest border border-outline-variant rounded-lg p-6 md:p-8 shadow-sm space-y-6">
        ...
        <div class="space-y-4">
          <div class="p-4 bg-surface rounded-lg border border-outline-variant space-y-2">
            ...
            <p class="text-xs text-on-surface-variant">Your annual family income (₹1L - ₹2.5L) falls well below the ceiling of ₹3,00,000 for EWS/OBC reservations.</p>
          </div>
...
function updateLangUI() {
  ...
  if (enBtn) enBtn.className = currentLang === 'en' ? 'px-1.5 py-0.5 rounded bg-primary text-white transition-all' : 'px-1.5 py-0.5 rounded hover:bg-surface-container-high transition-all';
  if (hiBtn) hiBtn.className = currentLang === 'hi' ? 'px-1.5 py-0.5 rounded bg-primary text-white transition-all' : 'px-1.5 py-0.5 rounded hover:bg-surface-container-high transition-all';
}
